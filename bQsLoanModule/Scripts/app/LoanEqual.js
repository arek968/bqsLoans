...
var LoanViewModel = function () {
    ...
    self.GetInstallments = function () {
        ...
        var strLoanDecreasingAPI = "../api/LoanEqual?LoanType=Housing&PaybackTime=" + document.getElementById("PaybackTime").value + "&Amount=" + document.getElementById("Amount").value;
